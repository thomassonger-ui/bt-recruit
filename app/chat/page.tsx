    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
      ...
      <main className="relative z-10 flex flex-1 flex-col items-center px-0 py-0 sm:px-4 sm:py-3 md:py-4">
        ...
        >
          ...
          {/* Calendly booking CTA — shown when Scout has fully qualified the lead */}
          {calendlyUrl && (
            <div style={{
              padding: "14px 16px",
              borderTop: "1px solid rgba(59,90,130,0.25)",
              background: "linear-gradient(135deg, rgba(11,29,58,0.95) 0%, rgba(27,54,93,0.95) 100%)",
              display: "flex",
              ...
              <p style={{
                ...
                Ready to lock in your time with Tom?
              </p>
              <a
                href={calendlyUrl}
                target="_blank"
