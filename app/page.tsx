    ...
    >
        ...
        <section style={{ padding: "clamp(48px,8vw,80px) clamp(20px,5vw,40px)", background: "#3f5f8a", position: "relative" }}>
          ...
          <div style={{ maxWidth: "860px", margin: "0 auto" }}>
            ...
            <Reveal delay={300}>
              <div style={{ display: "flex", justifyContent: "center" }}>
                <Link href="https://www.joinbearteam.com/chat" style={{ display: "inline-block" }}>
                  <button className="scout-cta-btn" style={{ padding: "14px 32px", fontSize: "1rem", fontWeight: 600, letterSpacing: "0.02em", background: "linear-gradient(135deg, #3b5a82 0%, #2c4a72 100%)", color: "#fff", border: "none", borderRadius: "8px", cursor: "pointer", boxShadow: "0 4px 20px rgba(59,90,130,0.45)", transition: "transform 0.2s ease, box-shadow 0.2s ease", minHeight: "44px" }}
                    onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(-2px)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 8px 28px rgba(59,90,130,0.55)"; }}
                    onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 4px 20px rgba(59,90,130,0.45)"; }}>
                    Talk to Scout →
                  </button>
      ...
      <section style={{ background: "#f0f3f8", padding: "clamp(48px,8vw,80px) clamp(20px,5vw,40px)" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto" }}>
          ...
          <div className="testimonial-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "28px" }}>
            {[
              {
                quote: "I was hovering at 6 deals a year, doing a little of everything with no real direction. Once I followed the system, I hit 12 deals without working more hours.",
                name: "Lauren S.",
                detail: "RE/MAX \u2192 Bear Team",
                stat: "Stuck Mid-Level \u2014 Breakthrough",
                initials: "L",
                color: "#1B8C3A",
              },
              {
                quote: "I was doing everything manually\u2014calls, follow-ups, tracking\u2014and it was exhausting. This system simplified everything. I\u2019m working less and closing more.",
                name: "Stephanie L.",
                detail: "eXp Realty \u2192 Bear Team",
                stat: "Burned-Out Agent \u2014 Reset",
                initials: "S",
                color: "#3b5a82",
              },
              {
                quote: "I used to think I needed to work harder. Turns out I needed a system. The daily plan, follow-up, and scripts changed everything. I\u2019m doing fewer things\u2014but closing more deals.",
                name: "Chris D.",
      ...
      {/* ── FINAL CTA ── */}
        ...
        <section style={{ padding: "clamp(48px,8vw,80px) clamp(20px,5vw,40px)", background: "#f0f3f8", textAlign: "center" }}>
          ...
          <Reveal delay={200}>
            <div style={{ display: "flex", justifyContent: "center" }}>
              <a href="https://calendly.com/thomas-songer/bear-team-meet" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block" }}>
                <button className="scout-cta-btn" style={{ padding: "14px 32px", fontSize: "1rem", fontWeight: 600, letterSpacing: "0.02em", background: "linear-gradient(135deg, #3b5a82 0%, #2c4a72 100%)", color: "#fff", border: "none", borderRadius: "8px", cursor: "pointer", boxShadow: "0 4px 20px rgba(59,90,130,0.45)", transition: "transform 0.2s ease, box-shadow 0.2s ease", minHeight: "44px" }}
                  onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(-2px)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 8px 28px rgba(59,90,130,0.55)"; }}
                  onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 4px 20px rgba(59,90,130,0.45)"; }}>
